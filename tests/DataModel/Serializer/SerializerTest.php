...
class SerializerTest extends FunctionalTest
{
    ...
    public function testEncodingEntity(): void
    {
        ...
        $entity->del('foo2');
        $this->assertEquals('{"type":"ENTITY","entity_id":null,"entity_type":10,"snapshot":{"type":"SNAPSHOT","version":null,"data":{"foo1":{"type":"STRING","trans":{"en":"bar1"}}}}}', $this->getSerializer()->encode($entity));
        ...
        $this->assertEquals('{"type":"ENTITY","entity_id":null,"entity_type":10,"snapshot":{"type":"SNAPSHOT","version":null,"data":{"foo1":{"type":"STRING","trans":{"en":"bar1","es":"bar2"}}}}}', $this->getSerializer()->encode($entity));
    }
    ...
    public function testDecodingEntity(): void
    {
        ...
        // test fully realized
        $json = '{"type":"ENTITY","entity_id":"c7a556c7-6f27-4049-bdbf-963379154a6f","entity_type":10,"snapshot":{"type":"SNAPSHOT","version":null,"data":{"foo1":{"type":"STRING","trans":{"en":"bar1","es":"bar2"}}}}}';
        $entity = $this->getSerializer()->decode($json);
        $entity->load(LanguageCodes::ENGLISH);
        $this->assertInstanceOf(Entity::class, $entity);
