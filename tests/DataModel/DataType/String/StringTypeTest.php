...
class StringTypeTest extends TestCase implements TypeTestInterface
{
    ...
    {
        // no constructor aruguments provided to StringType
    ...
    public function testFromArrayException(): void
    {
        ...
        $sut = new StringType();
        try {
            $sut->fromArray(['type' => 'STRING', 'val' => 'foo']);
            $this->fail('Exception not thrown.');
        } catch (WanderlusterException $e) {
            $this->assertEquals('Error hydrating STRING data type - field val must be an array.', $e->getMessage());
        }
    ...
    public function testSetGetVersion(): void
    {
        try {
            ...
            $this->assertEquals('Unable to set version for data type: STRING', $e->getMessage());
        }
    }
    ...
    public function testMergeException(): void
    {
        ...
        try {
            ...
            $this->assertEquals('Unable to merge BOOL with STRING.', $e->getMessage());
        }
    }
    ...
    public function testIsGreaterThan(): void
    {
        $sut = new StringType();
        try {
            $sut->isGreaterThan(new StringType());
            $this->fail('Exception not thrown.');
        } catch (Exception $e) {
            $this->assertEquals('Unable to use comparisons with data type: STRING.', $e->getMessage());
        }
    }
